# 1 "s1_64_sub_2.unroll.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 404 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "s1_64_sub_2.unroll.c" 2
# 25 "s1_64_sub_2.unroll.c"
# 1 "./header.h" 1
# 25 "./header.h"
...
# 1 "/usr/local/lib/clang/16.0.0/include/stddef.h" 1 3 4
# 46 "/usr/local/lib/clang/16.0.0/include/stddef.h" 3 4
typedef long unsigned int size_t;
# 34 "/usr/include/stdio.h" 2 3 4


# 1 "/usr/local/lib/clang/16.0.0/include/stdarg.h" 1 3 4
# 14 "/usr/local/lib/clang/16.0.0/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 34 "/usr/local/lib/clang/16.0.0/include/stdarg.h" 3 4
...
# 27 "./header.h" 2
# 1 "/usr/local/lib/clang/16.0.0/include/stdbool.h" 1 3
# 28 "./header.h" 2
...
void atimer(const char* title, _Bool print);
# 26 "s1_64_sub_2.unroll.c" 2

int output[64] __attribute__((aligned(16)));
int input1[64] __attribute__((aligned(16)));
int input2[64] __attribute__((aligned(16)));
...
int main(int argc,char* argv[]){
  ...
  { struct timeval Start, End; example1(); gettimeofday(&Start, 0);for (int i=0; i < (1048576*4/64*256); ++i) example1(); gettimeofday(&End, 0); unsigned r = digest_memory(&output[0], &output[64]); long mtime, s,us; s = End.tv_sec - Start.tv_sec; us = End.tv_usec - Start.tv_usec; mtime = (s*1000 + us/1000.0)+0.5; if (1) printf("%ld",mtime);};
